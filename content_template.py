#!/usr/bin/env python3
"""
Content Page Template Generator - With Grey Box in Upper Right
"""
...
def create_content_page_template(issue_number="XX", date="00.00.202X", page_number="X"):
    """Create the exact Content Page Template with grey box in upper right
    ...
    output_path = "templates/content_page_template.pdf"
